...
* The original package name 'com.example.Spring Security using Spring Data JPA + MySQL + Spring Boot' is invalid and this project uses 'com.example.Spring.Security.using.Spring.Data.JPA.MySQL.Spring.Boot' instead.
